...
class DiscsControllerTest < ActionController::TestCase
  ...
  test "should create disc" do
    assert_difference('Disc.count') do
      post :create, disc: { asin: @disc.asin, name: @disc.name, release_date: @disc.release_date, summary: @disc.summary }
    end
  ...
  test "should update disc" do
    put :update, id: @disc, disc: { asin: @disc.asin, name: @disc.name, release_date: @disc.release_date, summary: @disc.summary }
    assert_redirected_to disc_path(assigns(:disc))
  end
